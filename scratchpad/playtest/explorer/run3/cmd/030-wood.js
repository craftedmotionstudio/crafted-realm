/* Run 3, stage 3: Survival Wood the wrong way round, then the first lessons in my own order. */
...
await near(133, 120.5, 'gatehouse east exit', 6); await near(128.5, 126.5, 'road', 8); await near(128.5, 137.5, 'road n', 8); await near(128.5, 146.5, 'wood south', 8);
