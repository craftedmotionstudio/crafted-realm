...
OUT=ROOT/'.studio-workspaces/holm-arrival-dock-v3/candidates'
...
PIV=Vector((2.62,-1.03,1.55));YAW=math.radians(-4);LIST=math.radians(4)   # waterline: sea at world -0.03, dock at world 1.00
def to_dock(p):
