...
OUT = ROOT / '.studio-workspaces/holm-provision-rack-v1/candidates'
...
profile('ProvisionHatchet',[(-.53,1.25),(-.42,1.24),(-.28,1.34),(-.24,1.18),
                            (-.29,1.095),(-.43,1.16),(-.53,1.16)],.103,.18,'Warm bronze')
...
manifest={'schema':'crafted-realms-local-prop-v1','id':'holm-provision-rack-v1',
          ...
          'builder':'tools/blender/build_holm_provision_rack_v1.py','palette':PALETTE,
