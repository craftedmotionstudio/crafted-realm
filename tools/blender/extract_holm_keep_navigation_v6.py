...
BASE=ROOT/'.studio-workspaces/holm-warden-keep-v8/candidates'
OUT=ROOT/'.studio-workspaces/holm-keep-navigation-v7/candidates'
SHA=hashlib.sha256((BASE/'keep.glb').read_bytes()).hexdigest()   # measured on warden keep v8 (v7 + z-fighting fix)
