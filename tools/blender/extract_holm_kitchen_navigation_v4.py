...
BASE=ROOT/'.studio-workspaces/holm-kitchen-wings-v6/candidates'
OUT=ROOT/'.studio-workspaces/holm-kitchen-navigation-v4/candidates'
SHA=hashlib.sha256((BASE/'kitchen-character.glb').read_bytes()).hexdigest()   # v4: measured on the kitchen wings v6 interior pass
...
targets=[]
for ident,label,x,y,z in [('entrance','Courtyard entrance',.5,0,1.5),('oven','Oven working stance',-2.5,0,-2.5),('prep','Preparation table',-2.5,0,.5),('pantry','Pantry shelving',4.5,0,-2.5),('loft','Upstairs room',-2.5,3.3,-3.5)]:
