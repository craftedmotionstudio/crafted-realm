"""Read-only actual Blender extraction (v3, 2026-09-25: lodge v5 = v4 + z-fighting fix): v5 lodge, foundation, terrain, rest-pose habitat.
...
# v2: the lodge v4 interior pass; the model hash is read from the file and recorded in the graph
...
NEWSHA=sha(ROOT/'.studio-workspaces/holm-quest-lodge-v5/candidates/lodge.glb')
# v2: the v3 material-equivalence check does not apply to the v4 interior pass (geometry changed off-node)
...
src=src.replace("holm-quest-lodge-v2/candidates","holm-quest-lodge-v5/candidates").replace("holm-quest-navigation-v1/candidates","holm-quest-terrain-navigation-v3/candidates").replace('6de1fd292bfdd0f3dd51bf0031297f8905eb72ff19a8ed9be759b7f4f738140b',NEWSHA)
...
data['renderDataUrl']='../.studio-workspaces/holm-quest-terrain-navigation-v3/candidates/terrain.json';data['renderDataSha256']=hashlib.sha256(terrain_bytes).hexdigest()
