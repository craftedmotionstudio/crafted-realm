...
BASE=ROOT/'.studio-workspaces/holm-kitchen-wings-v7/candidates'
OUT=ROOT/'.studio-workspaces/holm-kitchen-navigation-v5/candidates'
SHA=hashlib.sha256((BASE/'kitchen-character.glb').read_bytes()).hexdigest()   # v4: measured on kitchen wings v7 (v6 + z-fighting fix)
