"""Read-only actual Blender extraction (v2, 2026-09-25: lodge v4 interior pass): v4 lodge, foundation, terrain, rest-pose habitat.
...
NEWSHA=sha(ROOT/'.studio-workspaces/holm-quest-lodge-v4/candidates/lodge.glb')
...
src=src.replace("holm-quest-lodge-v2/candidates","holm-quest-lodge-v4/candidates").replace("holm-quest-navigation-v1/candidates","holm-quest-terrain-navigation-v2/candidates").replace('6de1fd292bfdd0f3dd51bf0031297f8905eb72ff19a8ed9be759b7f4f738140b',NEWSHA)
...
data['renderDataUrl']='../.studio-workspaces/holm-quest-terrain-navigation-v2/candidates/terrain.json';data['renderDataSha256']=hashlib.sha256(terrain_bytes).hexdigest()
