...
BASE=ROOT/'.studio-workspaces/holm-warden-keep-v6/candidates'
OUT=ROOT/'.studio-workspaces/holm-keep-navigation-v5/candidates'
SHA=hashlib.sha256((BASE/'keep.glb').read_bytes()).hexdigest()   # v4 script: measured on the warden keep v6 interior pass
