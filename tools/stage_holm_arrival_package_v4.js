...
// v4 (M3R, owner reviews 5+6, 2026-09-24): guide house v2 (jettied timber upper storey, half-hipped roof,
// dormer), the branching tree-family-v3 oak, and the Lantern Keeper statue on the approach.
const fs=require('fs'),path=require('path'),crypto=require('crypto'),cp=require('child_process');
const Package=require('../src/holm_arrival_package');
const root=path.resolve(__dirname,'..'),id='holm-arrival-package-v4';
...
const assets=[
 {id:'guide',ownerId:'holm_guide_hall',
  model:add('assets/models/holm_guide_house_overhaul_v2.glb','.studio-workspaces/holm-guide-house-overhaul-v2/candidates/holm_guide_house_overhaul_v2.glb'),
  authoring:add('assets/blender/holm_guide_house_overhaul_v2.blend','.studio-workspaces/holm-guide-house-overhaul-v2/candidates/holm_guide_house_overhaul_v2.blend'),
...
const input={provider:{id:'tutors-holm-v2',worldRevision:20260924},sources,assets};
