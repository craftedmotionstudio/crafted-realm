...
// the reviewed kit's manifest: node tools/build_holm_kit_catalog.js [workspace] (default the current kit, holm-characters-v28)
const WSK=process.argv[2]||'holm-characters-v28';
const m=JSON.parse(fs.readFileSync(path.join(ROOT,'.studio-workspaces',WSK,'candidates/manifest.json'),'utf8'));
...
const SLOTS=['Hair','Jaw','Torso','Arms','Hands','Legs','Feet','Makeup'],out={version:1,slots:SLOTS,bodies:{A:{},B:{}}};
