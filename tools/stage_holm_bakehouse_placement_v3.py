...
b=json.loads((ROOT/'.studio-workspaces/holm-overhaul-terrain-v1/working/assets/world/authoring/holm-overhaul.terrain.bundle.json').read_text(encoding='utf-8'))
model=ROOT/'.studio-workspaces/holm-kitchen-wings-v5/candidates/kitchen-character.glb'
assert hashlib.sha256(model.read_bytes()).hexdigest()=='3681d0feb35f6f44be9992822e46b0f6a290e28ce431dc6260df5cf3f5020216'
def height(x,z):
...
out=ROOT/'.studio-workspaces/holm-bakehouse-placement-v3/candidates';out.mkdir(parents=True,exist_ok=True);(out/'placement.json').write_text(json.dumps(data,indent=2),encoding='utf-8')
