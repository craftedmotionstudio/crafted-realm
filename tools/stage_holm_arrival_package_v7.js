...
const root=path.resolve(__dirname,'..'),id='holm-arrival-package-v7';
...
const sources={
 ...
 envelopes:add(authoring+'holm-arrival.envelopes.json','.studio-workspaces/holm-guide-house-overhaul-v4/candidates/guide-house-collision-envelopes.json'),
 dock:add(authoring+'holm-arrival.dock.json','docs/rebuild/holm-overhaul/arrival-dock.json',d=>({...d,model:'assets/models/holm_arrival_dock_overhaul_v3.glb'}))
};
const assets=[
 {id:'guide',ownerId:'holm_guide_hall',
  model:add('assets/models/holm_guide_house_overhaul_v4.glb','.studio-workspaces/holm-guide-house-overhaul-v4/candidates/holm_guide_house_overhaul_v4.glb'),
  authoring:add('assets/blender/holm_guide_house_overhaul_v4.blend','.studio-workspaces/holm-guide-house-overhaul-v4/candidates/holm_guide_house_overhaul_v4.blend'),
 ...
 {id:'dock',ownerId:'holm_arrival_dock',
  model:add('assets/models/holm_arrival_dock_overhaul_v3.glb','.studio-workspaces/holm-arrival-dock-v3/candidates/dock.glb'),
  authoring:add('assets/blender/holm_arrival_dock_overhaul_v3.blend','.studio-workspaces/holm-arrival-dock-v3/candidates/dock.blend'),parts:['DockDeck']}
];
...
const landscapeBase='.studio-workspaces/holm-arrival-landscape-measure-v3/candidates/';
...
const modelName={oak:'holm_arrival_oak_v3.glb',statue:'holm_arrival_statue_v2.glb'};
...
const statueSource=add('assets/blender/holm_arrival_statue_v2.blend','.studio-workspaces/holm-arrival-statue-v2/candidates/lantern_keeper_statue_v2.blend');
