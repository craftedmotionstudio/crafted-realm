...
const data=JSON.parse(fs.readFileSync('.studio-workspaces/holm-quest-navigation-v1/candidates/navigation.json','utf8'));
...
console.log('[QUEST_NAVIGATION_TEST] immutable graph, cardinal interpolation, unreachable and malformed edges pass; '+samples+' interpolation samples');
console.log(JSON.stringify(reached));
if(reached.some(t=>!t.reachable)){console.error('[QUEST_NAVIGATION_TEST] required destinations disconnected');process.exitCode=1;}
