...
function world(opts){
  ...
  const ctx={
    Math,Infinity,active:()=>true,Player:{},pending:null,passThrough:false,lessons:null,doors:{arrival:false,garden:false},water:null,extras:null,island:false,islandData:null,
