...
model=ROOT/'.studio-workspaces/holm-kitchen-wings-v4/candidates/kitchen-character.glb'
assert hashlib.sha256(model.read_bytes()).hexdigest()=='fa911f4634af7dd959d03430b25eb5765328cc46d52e792b4e2c944a87cc597e'
def height(x,z):
...
out=ROOT/'.studio-workspaces/holm-bakehouse-placement-v2/candidates';out.mkdir(parents=True,exist_ok=True);(out/'placement.json').write_text(json.dumps(data,indent=2),encoding='utf-8')
