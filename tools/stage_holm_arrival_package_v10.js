...
// v10 (2026-09-25 owner review of the statue): the Lantern Keeper v4 (posed on the v3.0 character kit: the raised fist grips the
// lantern's bail and the lantern hangs plumb below it; same footprint and root name), measured by measure_holm_arrival_landscape_v5.py.
// Otherwise v9:
...
const root=path.resolve(__dirname,'..'),id='holm-arrival-package-v10';
...
const assets=[
 {id:'guide',ownerId:'holm_guide_hall',
  model:add('assets/models/holm_guide_house_overhaul_v5.glb','.studio-workspaces/holm-guide-house-overhaul-v5/candidates/holm_guide_house_overhaul_v5.glb'),
  authoring:add('assets/blender/holm_guide_house_overhaul_v5.blend','.studio-workspaces/holm-guide-house-overhaul-v5/candidates/holm_guide_house_overhaul_v5.blend'),
...
const landscapeBase='.studio-workspaces/holm-arrival-landscape-measure-v5/candidates/';
...
const modelName={oak:'holm_arrival_oak_v3.glb',statue:'holm_arrival_statue_v4.glb'};
...
const statueSource=add('assets/blender/holm_arrival_statue_v4.blend','.studio-workspaces/holm-arrival-statue-v4/candidates/lantern_keeper_statue_v4.blend');
