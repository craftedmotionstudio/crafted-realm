...
// v5 (2026-09-25 interiors pass): guide house v3 (designed interiors, relief chart, cellar, chimney/log store/vane) and its
...
const root=path.resolve(__dirname,'..'),id='holm-arrival-package-v5';
