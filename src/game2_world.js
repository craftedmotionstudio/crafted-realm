...
function groundY(x,z){
  ...
  if(typeof HolmV3Preview!=='undefined'&&HolmV3Preview.active())return HolmV3Preview.height(x,z);
...
/* scatter prop builders (makeStick/makeBush/makeFlower/makeMushroom/makeReed/makeCliff/
   makeFountain/makeCactus/makeHut/makeAshPile/makeTorch/makeRowboat) -> src/world_scatter.js */
