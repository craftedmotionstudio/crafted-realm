...
var WorldV2Buildings=(function(){
  ...
  var ASSETS={
    ...
    holm_mage_tower_v1:{url:'/assets/models/buildings/holm_mage_tower_v1.glb?v=2',
      assetId:'holm_mage_tower',source:'blender-glb-v1',rootName:'asset-holm-mage-tower-v1',
      parts:['roof','west_door','south_door','rune_table','spell_lectern','tower_register','bookshelf','orrery','spiral_stair','casting_socket']}
  };
  var PROP_ASSETS={
    workyard_exterior_u3_v1:{url:'/assets/models/props/workyard_exterior_u3_v1.glb?v=1',
      parts:['workyard_exterior_u3_v1','timber_log_rack','log_stack','rope_restraints',
        'chopping_block','embedded_axe','sawbuck']},
    workyard_waterworks_u4_v1:{url:'/assets/models/props/workyard_waterworks_u4_v1.glb?v=2',
